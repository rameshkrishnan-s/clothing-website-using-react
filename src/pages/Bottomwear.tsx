...
const Bottomwear: React.FC = () => {
  // Define 20 unique products with actual topwear images
  const products = Array.from({ length: 20 }, (_, index) => ({
    id: index + 1,
    name: `Bottomwear ${index + 1}`,
    price: `$${(Math.random() * 100 + 10).toFixed(2)}`, // Random price from $10.00 to $110.00
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    imgSrc: `/images/bottomwear.jpeg`, // Reuse 5 different topwear images
  }));

  return (
    <div className="topwear-container">
      <h1 className="topwear-title">Bottomwear Collection</h1>
